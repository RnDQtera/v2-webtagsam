...
WebUI.setText(findTestObject('Setting/004 Setting - Role/OBJ.004.032 FIeld Serach Approval - Disposal'), 'John Born')
...
WebUI.click(findTestObject('Setting/005 Setting - Audit/OBJ.005.003 Remove Approver Level'), FailureHandling.STOP_ON_FAILURE)
