...
WebUI.sendKeys(findTestObject('Setting/004 Setting - Role/OBJ.004.006 Pick Data by Search'), Keys.chord(Keys.ESCAPE))
...
WebUI.click(findTestObject('Setting/004 Setting - Role/OBJ.004.015 Pick Data Approval'), FailureHandling.STOP_ON_FAILURE)
