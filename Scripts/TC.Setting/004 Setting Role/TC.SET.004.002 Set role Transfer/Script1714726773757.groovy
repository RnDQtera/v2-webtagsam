...
WebUI.click(findTestObject('Setting/004 Setting - Role/OBJ.004.023 sub tab transfer'), FailureHandling.STOP_ON_FAILURE)
...
WebUI.click(findTestObject('Setting/004 Setting - Role/OBJ.004.010 Add Approval by Or'), FailureHandling.STOP_ON_FAILURE)

WebUI.setText(findTestObject('Setting/004 Setting - Role/OBJ.004.012 Search Approvers'), 'Laurent abigails')

WebUI.sendKeys(findTestObject('Setting/004 Setting - Role/OBJ.004.012 Search Approvers'), Keys.chord(Keys.ENTER))

'Komponene Berbeda Disetiap Tab Check box\r\n'
WebUI.click(findTestObject('Setting/004 Setting - Role/OBJ.004.025 Pick Data Approval - Transfer'), FailureHandling.STOP_ON_FAILURE)

WebUI.sendKeys(findTestObject('Setting/004 Setting - Role/OBJ.004.012 Search Approvers'), Keys.chord(Keys.ESCAPE))

WebUI.click(findTestObject('Setting/004 Setting - Role/OBJ.004.013 Add Approval Level'), FailureHandling.STOP_ON_FAILURE)

WebUI.click(findTestObject('Setting/004 Setting - Role/OBJ.004.014 Add Approval by AND'), FailureHandling.STOP_ON_FAILURE)

WebUI.click(findTestObject('Setting/004 Setting - Role/OBJ.004.016 Add Approvers Level 2'), FailureHandling.STOP_ON_FAILURE)

WebUI.click(findTestObject('Setting/004 Setting - Role/OBJ.004.017 Select all Level 2'), FailureHandling.STOP_ON_FAILURE)

WebUI.sendKeys(findTestObject('Setting/004 Setting - Role/OBJ.004.018 Field Level 2'), Keys.chord(Keys.ESCAPE))

WebUI.click(findTestObject('Setting/004 Setting - Role/OBJ.004.019 Delete Level Approval'), FailureHandling.STOP_ON_FAILURE)

WebUI.delay(2, FailureHandling.STOP_ON_FAILURE)

WebUI.click(findTestObject('Setting/004 Setting - Role/OBJ.004.020 Confirm Delete Approval'), FailureHandling.STOP_ON_FAILURE)
