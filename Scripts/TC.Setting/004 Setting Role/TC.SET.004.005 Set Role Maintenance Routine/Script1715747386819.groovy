...
'Switch Sub Tab\r\n'
WebUI.click(findTestObject('Setting/006 Setting Maintenance Routine/OBJ.006.001 Select Tab Maintenance Routine'), FailureHandling.STOP_ON_FAILURE)
...
WebUI.click(findTestObject('Setting/006 Setting Maintenance Routine/OBJ.006.003 Remove Approver Level'), FailureHandling.STOP_ON_FAILURE)
