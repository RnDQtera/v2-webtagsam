...
'\r\n'
WebUI.click(findTestObject('Setting/017 Setting Custom Field - General Information/OBJ.017.055 Action active-inactive'), 
    FailureHandling.STOP_ON_FAILURE)

WebUI.delay(3, FailureHandling.STOP_ON_FAILURE)

'\r\n'
WebUI.click(findTestObject('Setting/017 Setting Custom Field - General Information/OBJ.017.057 Submit action'), FailureHandling.STOP_ON_FAILURE)

WebUI.delay(3, FailureHandling.STOP_ON_FAILURE)

WebUI.takeScreenshot('C:/Users/aplikasi internal/Documents/Clone TS V2/v2-webtagsam/Screenshot/TC.SET.009.006.png', FailureHandling.STOP_ON_FAILURE)
