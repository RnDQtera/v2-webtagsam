...
WebUI.click(findTestObject('003 Setting - Group/OBJ.003.023 Button Search'), FailureHandling.STOP_ON_FAILURE)

WebUI.setText(findTestObject('003 Setting - Group/OBJ.003.024 Field Search'), 'Basement')

WebUI.sendKeys(findTestObject('003 Setting - Group/OBJ.003.024 Field Search'), Keys.chord(Keys.ENTER))

WebUI.sendKeys(findTestObject('003 Setting - Group/OBJ.003.024 Field Search'), Keys.chord(Keys.CONTROL, 'a'))

WebUI.setText(findTestObject('003 Setting - Group/OBJ.003.024 Field Search'), 'Lantai')

WebUI.sendKeys(findTestObject('003 Setting - Group/OBJ.003.024 Field Search'), Keys.chord(Keys.ENTER))

WebUI.click(findTestObject('003 Setting - Group/OBJ.003.024 Field Search'), FailureHandling.STOP_ON_FAILURE)

WebUI.click(findTestObject('003 Setting - Group/OBJ.003.025 Download Excel'), FailureHandling.STOP_ON_FAILURE)
