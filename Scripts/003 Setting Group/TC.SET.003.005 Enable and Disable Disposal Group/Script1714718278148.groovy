...
WebUI.click(findTestObject('003 Setting - Group/OBJ.003.026 Select all group'), FailureHandling.STOP_ON_FAILURE)

WebUI.click(findTestObject('003 Setting - Group/OBJ.003.027 Select Bulk Action'), FailureHandling.STOP_ON_FAILURE)

WebUI.click(findTestObject('003 Setting - Group/OBJ.003.029 Bulk Action Disable Dispose'), FailureHandling.STOP_ON_FAILURE)
...
WebUI.click(findTestObject('003 Setting - Group/OBJ.003.028 Bulk Action Enable Dispose'), FailureHandling.STOP_ON_FAILURE)
