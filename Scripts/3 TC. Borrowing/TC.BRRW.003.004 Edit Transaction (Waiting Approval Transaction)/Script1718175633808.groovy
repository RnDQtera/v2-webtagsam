...
WebUI.click(findTestObject('03 Transaction/001 Borrowing/OBJ.001.022 Edit Request Transaction Borrowing'), FailureHandling.STOP_ON_FAILURE)

WebUI.click(findTestObject('03 Transaction/001 Borrowing/OBJ.001.023 Edit Data Borrower'), FailureHandling.STOP_ON_FAILURE)

WebUI.click(findTestObject('03 Transaction/001 Borrowing/OBJ.001.024 Select Data User for Edited'), FailureHandling.STOP_ON_FAILURE)

WebUI.click(findTestObject('03 Transaction/001 Borrowing/OBJ.001.025 Submit Edited Data'), FailureHandling.STOP_ON_FAILURE)

WebUI.click(findTestObject('03 Transaction/001 Borrowing/OBJ.001.026 Save Data Edited'), FailureHandling.STOP_ON_FAILURE)
