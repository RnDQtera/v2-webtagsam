...
WebUI.click(findTestObject('07 File manager/002 File manager borrow recycle bin/OBJ.002.006 Asset 1'), FailureHandling.STOP_ON_FAILURE)

WebUI.delay(3, FailureHandling.STOP_ON_FAILURE)

WebUI.click(findTestObject('07 File manager/002 File manager borrow recycle bin/OBJ.002.007 Bulk action'), FailureHandling.STOP_ON_FAILURE)

WebUI.delay(3, FailureHandling.STOP_ON_FAILURE)

WebUI.click(findTestObject('07 File manager/002 File manager borrow recycle bin/OBJ.002.009 Bulk delete'), FailureHandling.STOP_ON_FAILURE)

WebUI.delay(3, FailureHandling.STOP_ON_FAILURE)

WebUI.click(findTestObject('07 File manager/002 File manager borrow recycle bin/OBJ.002.005 Submit permanently damaged'), 
    FailureHandling.STOP_ON_FAILURE)

WebUI.delay(3, FailureHandling.STOP_ON_FAILURE)

WebUI.takeScreenshot('C:/Users/DELL/Documents/Clone Git/clone otomasti v2/v2-webtagsam/Screenshot/TC.FM.001.007.png', FailureHandling.STOP_ON_FAILURE)
