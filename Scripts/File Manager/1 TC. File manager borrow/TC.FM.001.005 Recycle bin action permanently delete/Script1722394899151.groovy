...
WebUI.click(findTestObject('07 File manager/002 File manager borrow recycle bin/OBJ.002.004 Action permanently damaged'), 
    FailureHandling.STOP_ON_FAILURE)
...
WebUI.takeScreenshot('C:/Users/DELL/Documents/Clone Git/clone otomasti v2/v2-webtagsam/Screenshot/TC.FM.001.005.png', FailureHandling.STOP_ON_FAILURE)
