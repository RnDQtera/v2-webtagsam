...
WebUI.click(findTestObject('07 File manager/002 File manager borrow recycle bin/OBJ.002.010 Recover all'), FailureHandling.STOP_ON_FAILURE)

WebUI.delay(3, FailureHandling.STOP_ON_FAILURE)

WebUI.takeScreenshot('C:/Users/DELL/Documents/Clone Git/clone otomasti v2/v2-webtagsam/Screenshot/TC.FM.001.008.png', FailureHandling.STOP_ON_FAILURE)
