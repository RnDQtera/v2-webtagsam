...
WebUI.setText(findTestObject('02 Setting/001 Login and OTP/OBJ.001.001 Email'), GlobalVariable.borrower)
...
WebUI.click(findTestObject('03 Transaction/001 Borrowing/OBJ.001.044 My Profile'), FailureHandling.STOP_ON_FAILURE)

WebUI.click(findTestObject('03 Transaction/001 Borrowing/OBJ.001.045 My Asset'), FailureHandling.STOP_ON_FAILURE)
