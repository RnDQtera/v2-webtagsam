...
WebUI.setText(findTestObject('02 Setting/001 Login and OTP/OBJ.001.001 Email'), 'dzul@mailnesia.com')
...
WebUI.takeScreenshot('Scre/TC.Log.001.006 Insert Unregiter Email.png', FailureHandling.STOP_ON_FAILURE)
