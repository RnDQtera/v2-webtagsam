...
'\r\n'
WebUI.setText(findTestObject('02 Setting/026 Setting - Transaction/OBJ.026.002 Input max borrowing time'), '12')

'\r\n'
WebUI.setText(findTestObject('02 Setting/026 Setting - Transaction/OBJ.026.003 Input default borrowing time'), '2')

'\r\n'
WebUI.setText(findTestObject('02 Setting/026 Setting - Transaction/OBJ.026.004 Confirmation email timeout'), '21')

'\r\n'
WebUI.click(findTestObject('02 Setting/026 Setting - Transaction/OBJ.026.005 Save button'), FailureHandling.STOP_ON_FAILURE)

WebUI.delay(3, FailureHandling.STOP_ON_FAILURE)

'\r\n'
WebUI.takeScreenshot('C:/Users/DELL/Documents/Clone Git/clone otomasti v2/v2-webtagsam/Screenshot/TC.SET.018.001.png', FailureHandling.STOP_ON_FAILURE)
