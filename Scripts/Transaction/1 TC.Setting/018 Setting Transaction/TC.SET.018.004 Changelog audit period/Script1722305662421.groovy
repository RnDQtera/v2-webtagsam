...
'\r\n'
WebUI.click(findTestObject('02 Setting/026 Setting - Transaction/OBJ.026.019 Tab audit'), FailureHandling.STOP_ON_FAILURE)
...
'\r\n'
WebUI.setText(findTestObject('02 Setting/026 Setting - Transaction/OBJ.026.008 Input search'), 'max grace')
...
'\r\n'
WebUI.click(findTestObject('02 Setting/026 Setting - Transaction/OBJ.026.020 Apply filet CL audit'), FailureHandling.STOP_ON_FAILURE)
...
'\r\n'
WebUI.takeScreenshot('C:/Users/DELL/Documents/Clone Git/clone otomasti v2/v2-webtagsam/Screenshot/TC.SET.018.004.png', FailureHandling.STOP_ON_FAILURE)
