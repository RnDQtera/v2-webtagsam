...
'\r\n'
WebUI.click(findTestObject('02 Setting/022 Setting Asset Transactional Policy - Transactionable/OBJ.022.050 Bulk nontransactionable'), FailureHandling.STOP_ON_FAILURE)
