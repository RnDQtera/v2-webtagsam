...
'\r\n'
WebUI.click(findTestObject('02 Setting/023 Setting Asset Transactional Policy - Non transactionable/OBJ.023.003 Single option'), 
    FailureHandling.STOP_ON_FAILURE)

WebUI.delay(3, FailureHandling.STOP_ON_FAILURE)

'\r\n'
WebUI.click(findTestObject('02 Setting/023 Setting Asset Transactional Policy - Non transactionable/OBJ.023.004 Act move to transactioable'), 
    FailureHandling.STOP_ON_FAILURE)

WebUI.delay(3, FailureHandling.STOP_ON_FAILURE)

'\r\n'
WebUI.click(findTestObject('02 Setting/022 Setting Asset Transactional Policy - Transactionable/OBJ.022.042 Continue'), 
    FailureHandling.STOP_ON_FAILURE)

WebUI.delay(3, FailureHandling.STOP_ON_FAILURE)

WebUI.takeScreenshot('C:/Users/DELL/Documents/Clone Git/clone otomasti v2/v2-webtagsam/Screenshot/TC.SET.015.003.png', FailureHandling.STOP_ON_FAILURE)
