...
'Switch Sub Tab\r\n'
WebUI.click(findTestObject('02 Setting/008 Tracking/OBJ.008.001 Select Tab Tracking'), FailureHandling.STOP_ON_FAILURE)
...
WebUI.click(findTestObject('02 Setting/008 Tracking/OBJ.008.002 Disable manage by parernt group'), FailureHandling.STOP_ON_FAILURE)
...
WebUI.click(findTestObject('02 Setting/008 Tracking/OBJ.008.003 Remove Approver Level'), FailureHandling.STOP_ON_FAILURE)
