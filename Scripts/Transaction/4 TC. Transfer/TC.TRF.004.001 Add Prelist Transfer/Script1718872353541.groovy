...
WebUI.click(findTestObject('03 Transaction/002 Transfer/OBJ.002.001 Add Transfer Pre-List'), FailureHandling.STOP_ON_FAILURE)

WebUI.click(findTestObject('03 Transaction/002 Transfer/OBJ.002.002 Search Destination for Transfer Pre-list'), FailureHandling.STOP_ON_FAILURE)

WebUI.setText(findTestObject('03 Transaction/002 Transfer/OBJ.002.002 Search Destination for Transfer Pre-list'), 'Backend Area')

WebUI.click(findTestObject('03 Transaction/002 Transfer/OBJ.002.003 Choose Option Transfer Pre-List'), FailureHandling.STOP_ON_FAILURE)

WebUI.click(findTestObject('03 Transaction/002 Transfer/OBJ.002.004 Submit Destination Transfer'), FailureHandling.STOP_ON_FAILURE)

WebUI.click(findTestObject('03 Transaction/002 Transfer/OBJ.002.005 Confirm Linked Asset'), FailureHandling.STOP_ON_FAILURE)
