...
WebUI.click(findTestObject('01 Asset/002 Search Asset, Filter and Download/OBJ.002.009 Select Filter Category'), FailureHandling.STOP_ON_FAILURE)
...
WebUI.click(findTestObject('01 Asset/002 Search Asset, Filter and Download/OBJ.002.018 Select Filter Tag type'), FailureHandling.STOP_ON_FAILURE)

WebUI.click(findTestObject('01 Asset/002 Search Asset, Filter and Download/OBJ.002.019 Choose Filter Tag Type'), FailureHandling.STOP_ON_FAILURE)
...
WebUI.click(findTestObject('01 Asset/002 Search Asset, Filter and Download/OBJ.002.023 Submit Select Filter Group'), FailureHandling.STOP_ON_FAILURE)

WebUI.click(findTestObject('01 Asset/002 Search Asset, Filter and Download/OBJ.002.024 Select Filter Status'), FailureHandling.STOP_ON_FAILURE)

WebUI.setText(findTestObject('01 Asset/002 Search Asset, Filter and Download/OBJ.002.025 Search Filter Status'), 'Available')

WebUI.click(findTestObject('01 Asset/002 Search Asset, Filter and Download/OBJ.002.026 Choose Filter Status'), FailureHandling.STOP_ON_FAILURE)

WebUI.click(findTestObject('01 Asset/002 Search Asset, Filter and Download/OBJ.002.027 Select Filter Maintenance'), FailureHandling.STOP_ON_FAILURE)

WebUI.setText(findTestObject('01 Asset/002 Search Asset, Filter and Download/OBJ.002.028 Search Filter maintenance'), 'None')

WebUI.click(findTestObject('01 Asset/002 Search Asset, Filter and Download/OBJ.002.029 Choose In Maintenance'), FailureHandling.STOP_ON_FAILURE)

WebUI.click(findTestObject('01 Asset/002 Search Asset, Filter and Download/OBJ.002.030 Select Filter Transactional Policy'), 
    FailureHandling.STOP_ON_FAILURE)
...
WebUI.click(findTestObject('01 Asset/002 Search Asset, Filter and Download/OBJ.002.042 Reset Filter'), FailureHandling.STOP_ON_FAILURE)

WebUI.click(findTestObject('01 Asset/002 Search Asset, Filter and Download/OBJ.002.005 Button Filter'), FailureHandling.STOP_ON_FAILURE)

'Bugs Download Available Asset All\r\n'
WebUI.click(findTestObject('01 Asset/002 Search Asset, Filter and Download/OBJ.002.043 Download Data Table Available All'), 
    FailureHandling.STOP_ON_FAILURE)
