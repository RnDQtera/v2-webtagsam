...
'Switch Sub Tab\r\n'
WebUI.click(findTestObject('02 Setting/004 Setting - Role/OBJ.004.026 Tab Disposal'), FailureHandling.STOP_ON_FAILURE)
...
WebUI.setText(findTestObject('02 Setting/004 Setting - Role/OBJ.004.032 FIeld Serach Approval - Disposal'), 'Laurent abigails')
