...
'\r\n'
WebUI.click(findTestObject('02 Setting/010 Create Role/OBJ.010.049 Submit Create Role'), FailureHandling.STOP_ON_FAILURE)
...
'\r\n'
WebUI.setText(findTestObject('02 Setting/009 Set Role/OBJ.009.003 Field Search Data Table'), 'Testing Role')

'\r\n'
WebUI.sendKeys(findTestObject('02 Setting/009 Set Role/OBJ.009.003 Field Search Data Table'), Keys.chord(Keys.ENTER))

'\r\n'
WebUI.click(findTestObject('02 Setting/010 Create Role/OBJ.010.050 Single Action Role'), FailureHandling.STOP_ON_FAILURE)

'\r\n'
WebUI.click(findTestObject('02 Setting/010 Create Role/OBJ.010.055 Action Edit'), FailureHandling.STOP_ON_FAILURE)
...
'\r\n'
WebUI.click(findTestObject('02 Setting/010 Create Role/OBJ.010.002 Create Role Name'), FailureHandling.STOP_ON_FAILURE)

'\r\n'
WebUI.sendKeys(findTestObject('02 Setting/010 Create Role/OBJ.010.002 Create Role Name'), Keys.chord(Keys.CONTROL, 'a'))

'\r\n'
WebUI.setText(findTestObject('02 Setting/010 Create Role/OBJ.010.002 Create Role Name'), 'Role Edited')

'\r\n'
WebUI.click(findTestObject('02 Setting/010 Create Role/OBJ.010.056 Save Edit'), FailureHandling.STOP_ON_FAILURE)
...
'\r\n'
WebUI.setText(findTestObject('02 Setting/009 Set Role/OBJ.009.003 Field Search Data Table'), 'Role Edited')
...
'\r\n'
WebUI.click(findTestObject('02 Setting/010 Create Role/OBJ.010.057 Detail Role'), FailureHandling.STOP_ON_FAILURE)

'\r\n'
WebUI.delay(2, FailureHandling.STOP_ON_FAILURE)

'\r\n'
WebUI.click(findTestObject('02 Setting/010 Create Role/OBJ.010.058 Closed View Role'), FailureHandling.STOP_ON_FAILURE)

'\r\n'
WebUI.click(findTestObject('02 Setting/010 Create Role/OBJ.010.050 Single Action Role'), FailureHandling.STOP_ON_FAILURE)

'\r\n'
WebUI.click(findTestObject('02 Setting/010 Create Role/OBJ.010.051 Single Action Delete in Menu Role'), FailureHandling.STOP_ON_FAILURE)

'\r\n'
WebUI.click(findTestObject('02 Setting/010 Create Role/OBJ.010.052 Confirmation Delete Role'), FailureHandling.STOP_ON_FAILURE)
