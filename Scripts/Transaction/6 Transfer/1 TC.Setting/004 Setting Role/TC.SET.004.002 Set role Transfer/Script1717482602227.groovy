...
WebUI.click(findTestObject('02 Setting/004 Setting - Role/OBJ.004.023 sub tab transfer'), FailureHandling.STOP_ON_FAILURE)
...
'Komponene Berbeda Disetiap Tab Check box\r\n'
WebUI.click(findTestObject('02 Setting/004 Setting - Role/OBJ.004.025 Pick Data Approval - Transfer'), FailureHandling.STOP_ON_FAILURE)
