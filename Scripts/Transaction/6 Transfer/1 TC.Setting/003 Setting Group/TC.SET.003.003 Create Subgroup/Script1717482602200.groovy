...
WebUI.click(findTestObject('02 Setting/003 Setting - Group/OBJ.003.018 Select Create Sub Group'), FailureHandling.STOP_ON_FAILURE)

WebUI.setText(findTestObject('02 Setting/003 Setting - Group/OBJ.003.019 Field Create Sub Group'), 'Group QA Lt.1')

WebUI.click(findTestObject('02 Setting/003 Setting - Group/OBJ.003.020 Clear Field Create Sub Group'), FailureHandling.STOP_ON_FAILURE)

WebUI.setText(findTestObject('02 Setting/003 Setting - Group/OBJ.003.019 Field Create Sub Group'), 'Group QA Lt.1')

WebUI.click(findTestObject('02 Setting/003 Setting - Group/OBJ.003.021 Disposable Cretae Group'), FailureHandling.STOP_ON_FAILURE)

WebUI.click(findTestObject('02 Setting/003 Setting - Group/OBJ.003.022 Submit Create Sub Group'), FailureHandling.STOP_ON_FAILURE)
