...
'\r\n'
WebUI.setText(findTestObject('02 Setting/016 Setting Asset Name - Measurement/OBJ.016.008 Input search'), 'QA')
...
'\r\n'
WebUI.click(findTestObject('02 Setting/016 Setting Asset Name - Measurement/OBJ.016.009 Download'), FailureHandling.STOP_ON_FAILURE)
