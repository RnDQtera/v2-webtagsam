...
WebUI.click(findTestObject('01 Asset/001 Register Asset/OBJ.001.023 Select Custom Field 2'), FailureHandling.STOP_ON_FAILURE)

WebUI.click(findTestObject('01 Asset/001 Register Asset/OBJ.001.024 Choose Custom Field 2'), FailureHandling.STOP_ON_FAILURE)
