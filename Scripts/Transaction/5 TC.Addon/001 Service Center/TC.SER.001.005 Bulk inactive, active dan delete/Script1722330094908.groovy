...
WebUI.click(findTestObject('04 Addon/002 Service center/OBJ.002.033 SC 1'), FailureHandling.STOP_ON_FAILURE)

WebUI.click(findTestObject('04 Addon/002 Service center/OBJ.002.034 SC 2'), FailureHandling.STOP_ON_FAILURE)

WebUI.click(findTestObject('04 Addon/002 Service center/OBJ.002.035 Bulk action'), FailureHandling.STOP_ON_FAILURE)

WebUI.delay(3, FailureHandling.STOP_ON_FAILURE)

WebUI.click(findTestObject('04 Addon/002 Service center/OBJ.002.037 Bulk inactive'), FailureHandling.STOP_ON_FAILURE)

WebUI.delay(3, FailureHandling.STOP_ON_FAILURE)

WebUI.click(findTestObject('04 Addon/002 Service center/OBJ.002.039 Submit bulk'), FailureHandling.STOP_ON_FAILURE)
...
WebUI.click(findTestObject('04 Addon/002 Service center/OBJ.002.036 Bulk activate'), FailureHandling.STOP_ON_FAILURE)
...
WebUI.click(findTestObject('04 Addon/002 Service center/OBJ.002.038 Bulk delete'), FailureHandling.STOP_ON_FAILURE)
...
WebUI.takeScreenshot('C:/Users/DELL/Documents/Clone Git/clone otomasti v2/v2-webtagsam/Screenshot/TC.SER.001.005.png', FailureHandling.STOP_ON_FAILURE)
