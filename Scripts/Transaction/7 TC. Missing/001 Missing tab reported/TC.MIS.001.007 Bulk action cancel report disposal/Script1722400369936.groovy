...
WebUI.setText(findTestObject('03 Transaction/003 Missing reported/OBJ.003.003 Input search'), 'reported disposal')
...
WebUI.click(findTestObject('03 Transaction/003 Missing reported/OBJ.003.036 Bulk 1 mark as found'), FailureHandling.STOP_ON_FAILURE)

WebUI.delay(3, FailureHandling.STOP_ON_FAILURE)

WebUI.click(findTestObject('03 Transaction/003 Missing reported/OBJ.003.031 Submit cancel report dispos'), FailureHandling.STOP_ON_FAILURE)

WebUI.delay(3, FailureHandling.STOP_ON_FAILURE)

WebUI.takeScreenshot('C:/Users/DELL/Documents/Clone Git/clone otomasti v2/v2-webtagsam/Screenshot/TC.MIS.001.007.png', FailureHandling.STOP_ON_FAILURE)
