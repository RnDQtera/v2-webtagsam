...
WebUI.setText(findTestObject('03 Transaction/003 Missing reported/OBJ.003.003 Input search'), 'missing')

WebUI.sendKeys(findTestObject('03 Transaction/003 Missing reported/OBJ.003.003 Input search'), Keys.chord(Keys.ENTER))

WebUI.delay(3, FailureHandling.STOP_ON_FAILURE)

WebUI.click(findTestObject('03 Transaction/003 Missing reported/OBJ.003.033 Asset 1'), FailureHandling.STOP_ON_FAILURE)

WebUI.delay(3, FailureHandling.STOP_ON_FAILURE)

WebUI.click(findTestObject('03 Transaction/003 Missing reported/OBJ.003.034 Bulk action'), FailureHandling.STOP_ON_FAILURE)

WebUI.delay(3, FailureHandling.STOP_ON_FAILURE)

WebUI.click(findTestObject('03 Transaction/003 Missing reported/OBJ.003.035 Bulk 2 report disposal'), FailureHandling.STOP_ON_FAILURE)

WebUI.delay(3, FailureHandling.STOP_ON_FAILURE)

WebUI.setText(findTestObject('03 Transaction/003 Missing reported/OBJ.003.029 Input note disposal'), 'automate testing')

WebUI.click(findTestObject('03 Transaction/003 Missing reported/OBJ.003.030 Submit report disposal'), FailureHandling.STOP_ON_FAILURE)

WebUI.delay(3, FailureHandling.STOP_ON_FAILURE)

WebUI.takeScreenshot('C:/Users/DELL/Documents/Clone Git/clone otomasti v2/v2-webtagsam/Screenshot/TC.MIS.001.006.png', FailureHandling.STOP_ON_FAILURE)
