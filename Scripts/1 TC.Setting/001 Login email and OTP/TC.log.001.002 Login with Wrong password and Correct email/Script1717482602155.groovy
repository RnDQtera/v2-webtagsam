...
WebUI.setText(findTestObject('02 Setting/001 Login and OTP/OBJ.001.002 Password'), 'testing')
...
WebUI.takeScreenshot('Scre/TC.Log.001.002 Login.png', FailureHandling.STOP_ON_FAILURE)
