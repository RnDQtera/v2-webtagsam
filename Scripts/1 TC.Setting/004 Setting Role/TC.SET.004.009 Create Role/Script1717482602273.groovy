...
'\r\n'
WebUI.setText(findTestObject('02 Setting/010 Create Role/OBJ.010.002 Create Role Name'), 'Testing Role1')
...
'\r\n'
WebUI.setText(findTestObject('02 Setting/009 Set Role/OBJ.009.003 Field Search Data Table'), 'Testing Role1')
