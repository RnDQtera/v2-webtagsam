...
'Switch Sub Tab\r\n'
WebUI.click(findTestObject('Setting/004 Setting - Role/OBJ.004.026 Tab Disposal'), FailureHandling.STOP_ON_FAILURE)
...
WebUI.click(findTestObject('Setting/004 Setting - Role/OBJ.004.003 Disable Managed by Parent Group'), FailureHandling.STOP_ON_FAILURE)

WebUI.click(findTestObject('Setting/004 Setting - Role/OBJ.004.004 Add Manager'), FailureHandling.STOP_ON_FAILURE)

WebUI.setText(findTestObject('Setting/004 Setting - Role/OBJ.004.005 Search Manager'), 'Laurent abigails')
...
WebUI.click(findTestObject('Setting/004 Setting - Role/OBJ.004.027 Add Staff'), FailureHandling.STOP_ON_FAILURE)

WebUI.click(findTestObject('Setting/004 Setting - Role/OBJ.004.028 Select All Staff'), FailureHandling.STOP_ON_FAILURE)

WebUI.sendKeys(findTestObject('Setting/004 Setting - Role/OBJ.004.029 Field Search Staff Name'), Keys.chord(Keys.ESCAPE))

'Komponene Berbeda Disetiap Tab Check box\r\n'
WebUI.click(findTestObject('Setting/004 Setting - Role/OBJ.004.030 Select type AND in Approver - Disposal'), FailureHandling.STOP_ON_FAILURE)

WebUI.click(findTestObject('Setting/004 Setting - Role/OBJ.004.031 Pick data approval - Disposal'), FailureHandling.STOP_ON_FAILURE)

WebUI.setText(findTestObject('Setting/004 Setting - Role/OBJ.004.032 FIeld Serach Approval - Disposal'), 'Laurent abigails')

WebUI.sendKeys(findTestObject('Setting/004 Setting - Role/OBJ.004.032 FIeld Serach Approval - Disposal'), Keys.chord(Keys.ENTER))

WebUI.click(findTestObject('Setting/004 Setting - Role/OBJ.004.033 Select Data Approval - Disposal'), FailureHandling.STOP_ON_FAILURE)

WebUI.sendKeys(findTestObject('Setting/004 Setting - Role/OBJ.004.032 FIeld Serach Approval - Disposal'), Keys.chord(Keys.ESCAPE))

WebUI.click(findTestObject('Setting/004 Setting - Role/OBJ.004.034 Add Approval Level 2 -Disposal'), FailureHandling.STOP_ON_FAILURE)

WebUI.click(findTestObject('Setting/004 Setting - Role/OBJ.004.035 Pick Data Level 2 - Disposal'), FailureHandling.STOP_ON_FAILURE)

WebUI.click(findTestObject('Setting/004 Setting - Role/OBJ.004.036 Select all data approval lv 2 - disposal'), FailureHandling.STOP_ON_FAILURE)

WebUI.sendKeys(findTestObject('Setting/004 Setting - Role/OBJ.004.032 FIeld Serach Approval - Disposal'), Keys.chord(Keys.ESCAPE))

WebUI.click(findTestObject('Setting/004 Setting - Role/OBJ.004.037 Delete Level Approval Disposal'), FailureHandling.STOP_ON_FAILURE)

WebUI.click(findTestObject('Setting/005 Setting - Audit/OBJ.005.001 Select Tab Audit'), FailureHandling.STOP_ON_FAILURE)
