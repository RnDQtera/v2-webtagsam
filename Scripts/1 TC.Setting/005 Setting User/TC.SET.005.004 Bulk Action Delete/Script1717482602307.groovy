...
'\r\n'
WebUI.click(findTestObject('Setting/012 Serach, Download and bulk action Data Table/OBJ.012.006 Sort Data Transaction Role'), FailureHandling.STOP_ON_FAILURE)

'\r\n'
WebUI.click(findTestObject('Setting/012 Serach, Download and bulk action Data Table/OBJ.012.007 Select data for bulk delete'), FailureHandling.STOP_ON_FAILURE)
...
'\r\n'
WebUI.click(findTestObject('Setting/012 Serach, Download and bulk action Data Table/OBJ.012.008 Bulk Delete'), FailureHandling.STOP_ON_FAILURE)

'\r\n'
WebUI.click(findTestObject('Setting/012 Serach, Download and bulk action Data Table/OBJ.012.009 Confirm Remove Bulk Action'), FailureHandling.STOP_ON_FAILURE)
