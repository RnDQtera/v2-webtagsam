...
WebUI.setText(findTestObject('Setting/003 Setting - Group/OBJ.003.005 Set Name New Group'), 'Group Testing QA')
...
WebUI.setText(findTestObject('Setting/003 Setting - Group/OBJ.003.009 Search Group Name'), 'Group Testing QA')
...
WebUI.click(findTestObject('Setting/003 Setting - Group/OBJ.003.013 Select Edit Group'), FailureHandling.STOP_ON_FAILURE)

WebUI.sendKeys(findTestObject('Setting/003 Setting - Group/OBJ.003.014 Field Edit Group'), Keys.chord(Keys.CONTROL, 'a'))

WebUI.setText(findTestObject('Setting/003 Setting - Group/OBJ.003.014 Field Edit Group'), 'Group QA')

WebUI.click(findTestObject('Setting/003 Setting - Group/OBJ.003.015 Clear Field Edit Group'), FailureHandling.STOP_ON_FAILURE)

WebUI.sendKeys(findTestObject('Setting/003 Setting - Group/OBJ.003.014 Field Edit Group'), Keys.chord(Keys.CONTROL, 'a'))

WebUI.setText(findTestObject('Setting/003 Setting - Group/OBJ.003.014 Field Edit Group'), 'Group QA')

WebUI.click(findTestObject('Setting/003 Setting - Group/OBJ.003.016 Disposable Edit Group'), FailureHandling.STOP_ON_FAILURE)

WebUI.click(findTestObject('Setting/003 Setting - Group/OBJ.003.017 Save Edit Group'), FailureHandling.STOP_ON_FAILURE)

WebUI.takeScreenshot('Scre/TC.SET.003.002 Edit Group.png', FailureHandling.STOP_ON_FAILURE)

WebUI.delay(5, FailureHandling.STOP_ON_FAILURE)

WebUI.setText(findTestObject('Setting/003 Setting - Group/OBJ.003.009 Search Group Name'), 'Group QA')
...
WebUI.click(findTestObject('Setting/003 Setting - Group/OBJ.003.011 Select Delete Group'), FailureHandling.STOP_ON_FAILURE)

WebUI.click(findTestObject('Setting/003 Setting - Group/OBJ.003.012 Confirm Delete Group'), FailureHandling.STOP_ON_FAILURE)
