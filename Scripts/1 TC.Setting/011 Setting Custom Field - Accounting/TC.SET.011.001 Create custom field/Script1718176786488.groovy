...
'\r\n'
WebUI.click(findTestObject('Setting/019 Setting Custom Field - Accounting/OBJ.019.002 Option date'), FailureHandling.STOP_ON_FAILURE)
...
'\r\n'
WebUI.click(findTestObject('Setting/018 Setting custom field - Purchase/OBJ.018.002 No req'), FailureHandling.STOP_ON_FAILURE)
...
'\r\n'
WebUI.setText(findTestObject('Setting/017 Setting Custom Field - General Information/OBJ.017.007 Input Search cat'), 'Chess')
...
'\r\n'
WebUI.takeScreenshot('C:/Users/aplikasi internal/Documents/Clone TS V2/v2-webtagsam/Screenshot/TC.SET.011.001.png', FailureHandling.STOP_ON_FAILURE)
