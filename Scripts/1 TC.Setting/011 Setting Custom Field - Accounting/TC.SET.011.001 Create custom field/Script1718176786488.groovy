...
'\r\n'
WebUI.click(findTestObject('02 Setting/019 Setting Custom Field - Accounting/OBJ.019.002 Option date'), FailureHandling.STOP_ON_FAILURE)
...
'\r\n'
WebUI.setText(findTestObject('02 Setting/017 Setting Custom Field - General Information/OBJ.017.007 Input Search cat'), 'Chess')
