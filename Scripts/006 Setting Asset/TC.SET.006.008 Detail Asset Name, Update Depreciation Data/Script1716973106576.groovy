...
'\r\n'
WebUI.click(findTestObject('014 Setting Asset Name/OBJ.013.101 Action Update Depreciation Data'), FailureHandling.STOP_ON_FAILURE)

'\r\n'
WebUI.click(findTestObject('014 Setting Asset Name/OBJ.013.102 Select Depreciation Group'), FailureHandling.STOP_ON_FAILURE)

'\r\n'
WebUI.click(findTestObject('014 Setting Asset Name/OBJ.013.103 Choose Depreciation Group'), FailureHandling.STOP_ON_FAILURE)

'\r\n'
WebUI.click(findTestObject('014 Setting Asset Name/OBJ.013.104 Select Account Code'), FailureHandling.STOP_ON_FAILURE)

'\r\n'
WebUI.click(findTestObject('014 Setting Asset Name/OBJ.013.105 Choose Account Code'), FailureHandling.STOP_ON_FAILURE)

'\r\n'
WebUI.click(findTestObject('014 Setting Asset Name/OBJ.013.106 Clear Field'), FailureHandling.STOP_ON_FAILURE)
...
'\r\n'
WebUI.click(findTestObject('014 Setting Asset Name/OBJ.013.107 submit depreciation setting'), FailureHandling.STOP_ON_FAILURE)
