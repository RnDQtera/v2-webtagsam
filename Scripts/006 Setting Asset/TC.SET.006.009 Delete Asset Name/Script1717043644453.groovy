...
'\r\n'
WebUI.click(findTestObject('014 Setting Asset Name/OBJ.013.108 Action Delete Asset Name'), FailureHandling.STOP_ON_FAILURE)

'\r\n'
WebUI.click(findTestObject('014 Setting Asset Name/OBJ.013.109 Confirm Delete'), FailureHandling.STOP_ON_FAILURE)
